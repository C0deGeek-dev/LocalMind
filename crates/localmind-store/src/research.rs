...
use localmind_core::{
    AuditEventKind, CandidateLesson, Confidence, EvidenceKind, EvidenceRef, LessonCategory,
    LessonId, SessionId, SuggestedAction,
};
...
impl BatchInsightPipeline {
    ...
    fn run(
        ...
        let audit_kind = match kind {
            "research" => AuditEventKind::ResearchInsightCreated,
            _ => AuditEventKind::DistillationCreated,
        };
