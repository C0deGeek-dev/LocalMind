use crate::{
    ImportedSession, MemoryPersistence, MemoryPersistenceError, ProjectConfig, ReviewQueue,
    ReviewQueueError, StoreConfigError,
};
use localmind_core::{
    AuditEventKind, CandidateDestination, CandidateLesson, Confidence, ContractError,
    DigestSection, DigestSectionKind, EvidenceKind, EvidenceRef, LessonCategory, LessonId,
    ReviewAnnotation, SessionId, SessionSummary, SuggestedAction, ValidationStatus,
};
...
impl CloseoutProcessor {
    pub fn closeout_project_session(
        ...
        for candidate in &output.candidates {
            persistence.record_custom_audit(
                AuditEventKind::CandidateLessonCreated,
                "localmind-closeout",
                candidate.id.as_str(),
