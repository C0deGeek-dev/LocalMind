...
pub use memory_persistence::{
    AuditRecord, CoverageGate, DocSearchReport, DocSearchResult, DocSearchStatus,
    EmbedQueryOutcome, MemoryPersistence, MemoryPersistenceError, MemoryProvenance, MemoryRecord,
    MemoryScanReport, MemoryScanStatus, MemorySearchResult, MemoryVectorCoverage, VectorKindScan,
    VectorSearchResult,
};
...
pub use revalidation::{
    derive_verification_query, is_revalidation_candidate, parse_verdict, RevalidationConfig,
    RevalidationReport, RevalidationVerdict, VerdictSource, VERDICT_PROMPT,
};
...
pub use sessions::{plan_retention, scan_sessions, RetentionPlan, RetentionPolicy, SessionEntry};
pub use signing::{
...
pub use status::{EmbeddingCapability, StatusSnapshot};
pub use sync_bundle::{
