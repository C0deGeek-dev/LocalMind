...
//! count and stamps `last_used_at` across the project **and** global stores.
//! These fields remain available through `list_memory` for host diagnostics.
//! The bump is best-effort and idempotent-per-call; a non-matching id
