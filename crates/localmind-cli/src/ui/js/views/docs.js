...
async function docSearch() {
  ...
  try {
    ...
    const states = {
      ...
      endpoint_unavailable: 'The embedding endpoint is configured but unreachable.<br><br>Run <code>localbox embed-serve</code>, verify <code>[inference] embedding_base_url</code> + <code>embedding_model</code> in <code>.localmind.toml</code>, and retry.',
