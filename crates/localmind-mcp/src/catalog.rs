...
pub fn catalog() -> Vec<ToolSpec> {
    vec![
        ...
        ToolSpec {
            ...
            description: "Read-only readiness snapshot of this project's LocalMind store: whether learning is enabled, whether the embedding endpoint is configured and actually answering, accepted-memory and pending-review counts, doc-index counts, and how much accepted memory carries an embedding. No writes, no network.",
            ...
            output_schema: Some(object_schema(
                json!({
                    ...
                    "embedding_state": { "type": "string" },
                    "embedding_detail": { "type": "string" },
                    "memory_active": { "type": "integer" },
                    "memory_vectors": { "type": "integer" },
                    "memory_vector_holes": { "type": "integer" },
                    "memory_vectors_stale": { "type": "integer" },
