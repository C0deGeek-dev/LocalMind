...
pub enum AuditEventKind {
    ...
    MemorySuperseded,
    MemoryFlaggedStale,
    /// A reviewer cleared a staleness flag — the "keep this" decision.
    /// Paired with [`AuditEventKind::MemoryFlaggedStale`] so the lifecycle is
    /// readable in both directions; a flag lifted with no trace is
