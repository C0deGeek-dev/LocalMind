...
Thanks for your interest in LocalMind, part of the [LocalX](https://c0degeek-dev.github.io/LocalStack/) stack.
...
Rust project. Before opening a pull request:

```
cargo build then cargo test --workspace
```
